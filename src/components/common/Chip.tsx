...
export const defaultChipStyle =
  'rounded-full cursor-pointer border-[0.7px] web:border text-center text-xxs web:text-sm w-20 xs:w-14 web:w-[104px] xs:h-6 xs:leading-6 h-8 leading-8 web:h-10 web:leading-10';
