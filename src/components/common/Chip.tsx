...
export const defaultChipStyle =
  'rounded-full cursor-pointer border-[0.7px] web:border text-center xs:text-[0.7rem] text-xxs web:text-sm xs:h-6 xs:leading-6 h-8 leading-8 web:h-10 web:leading-10';
