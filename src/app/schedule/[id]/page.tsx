  ...
  return (
    <>
      <div className="flex flex-col gap-2 pb-4 web:pb-[34px] border-b border-black100">
        ...
        <span className="text-black600 font-medium flex gap-1 items-center text-xxs web:text-sm">
          <Icon name="calendar" className="w-3 h-3 web:w-4 web:h-4" />
          {fullDate}.{day}
        </span>
      </div>
      <div className="flex flex-col gap-8 text-black-800 text-xs web:text-md pt-4 web:pt-8">
        <label className="grid grid-cols-[auto_1fr] web:grid-cols-[auto_308px] gap-4">
        ...
        <label className="grid grid-cols-[auto_1fr] web:grid-cols-[auto_308px] gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <span className="text-black600 font-medium">{platform}</span>
          </div>
        </label>
        <label className="grid grid-cols-[auto_1fr] web:grid-cols-[auto_308px] gap-4">
          <span className="font-bold flex gap-3 items-center">
